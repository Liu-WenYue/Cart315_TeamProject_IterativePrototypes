...
public class GA_FREE_Demo03 : MonoBehaviour
{
	...
	IEnumerator ShowDialogs()
	{
		...
		m_Dialog2.PlayInAnims(GUIAnimSystemFREE.eGUIMove.SelfAndChildren);		
		m_Dialog3.PlayInAnims(GUIAnimSystemFREE.eGUIMove.SelfAndChildren);		
		m_Dialog4.PlayInAnims(GUIAnimSystemFREE.eGUIMove.SelfAndChildren);
	...
	public void HideAllGUIs()
	{
		...
		m_Dialog2.PlayOutAnims(GUIAnimSystemFREE.eGUIMove.SelfAndChildren);
		m_Dialog3.PlayOutAnims(GUIAnimSystemFREE.eGUIMove.SelfAndChildren);
		m_Dialog4.PlayOutAnims(GUIAnimSystemFREE.eGUIMove.SelfAndChildren);
