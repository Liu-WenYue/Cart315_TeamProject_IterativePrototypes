...
public class GA_FREE_Demo08 : MonoBehaviour
{
	...
	public void HideAllGUIs()
	{
		...
		if(m_Bar1_IsOn==true)
			m_Bar1.PlayOutAnims(GUIAnimSystemFREE.eGUIMove.SelfAndChildren);
		if(m_Bar2_IsOn==true)
			m_Bar2.PlayOutAnims(GUIAnimSystemFREE.eGUIMove.SelfAndChildren);
		if(m_Bar3_IsOn==true)
			m_Bar3.PlayOutAnims(GUIAnimSystemFREE.eGUIMove.SelfAndChildren);
		if(m_Bar4_IsOn==true)
			m_Bar4.PlayOutAnims(GUIAnimSystemFREE.eGUIMove.SelfAndChildren);
	...
	void ToggleBar1()
	{
		...
		{
			// m_Bar1 moves in
			m_Bar1.PlayInAnims(GUIAnimSystemFREE.eGUIMove.SelfAndChildren);
		}
		else
		{
			// m_Bar1 moves out
	...
	void ToggleBar3()
	{
		...
		{
			// m_Bar3 moves in
			m_Bar3.PlayInAnims(GUIAnimSystemFREE.eGUIMove.SelfAndChildren);
		}
		else
		{
			// m_Bar3 moves out
	...
	void ToggleBar4()
	{
		...
		{
			// m_Bar4 moves in
			m_Bar4.PlayInAnims(GUIAnimSystemFREE.eGUIMove.SelfAndChildren);
		}
		else
		{
			// m_Bar4 moves out
