...
public class GA_FREE_Demo06 : MonoBehaviour
{
	...
	IEnumerator MoveInPrimaryButtons()
	{
		...
		// MoveIn all primary buttons
		m_PrimaryButton1.PlayInAnims(GUIAnimSystemFREE.eGUIMove.Self);	
		m_PrimaryButton2.PlayInAnims(GUIAnimSystemFREE.eGUIMove.Self);	
		m_PrimaryButton3.PlayInAnims(GUIAnimSystemFREE.eGUIMove.Self);	
		m_PrimaryButton4.PlayInAnims(GUIAnimSystemFREE.eGUIMove.Self);

		m_PrimaryButton5.PlayInAnims(GUIAnimSystemFREE.eGUIMove.Self);
	...
	{
		// MoveOut all primary buttons
		m_PrimaryButton1.PlayOutAnims(GUIAnimSystemFREE.eGUIMove.SelfAndChildren);
		m_PrimaryButton2.PlayOutAnims(GUIAnimSystemFREE.eGUIMove.SelfAndChildren);
		m_PrimaryButton3.PlayOutAnims(GUIAnimSystemFREE.eGUIMove.SelfAndChildren);
		m_PrimaryButton4.PlayOutAnims(GUIAnimSystemFREE.eGUIMove.SelfAndChildren);
		m_PrimaryButton5.PlayOutAnims(GUIAnimSystemFREE.eGUIMove.SelfAndChildren);
		
		// MoveOut all secondary buttons
		if(m_Button1_IsOn == true)
			m_SecondaryButton1.PlayOutAnims(GUIAnimSystemFREE.eGUIMove.SelfAndChildren);
		if(m_Button2_IsOn == true)
			m_SecondaryButton2.PlayOutAnims(GUIAnimSystemFREE.eGUIMove.SelfAndChildren);
		if(m_Button3_IsOn == true)
			m_SecondaryButton3.PlayOutAnims(GUIAnimSystemFREE.eGUIMove.SelfAndChildren);
		if(m_Button4_IsOn == true)
			m_SecondaryButton4.PlayOutAnims(GUIAnimSystemFREE.eGUIMove.SelfAndChildren);
		if(m_Button5_IsOn == true)
			m_SecondaryButton5.PlayOutAnims(GUIAnimSystemFREE.eGUIMove.SelfAndChildren);
	...
	void ToggleButton_1()
	{
		...
		if(m_Button1_IsOn==true)
		{
			...
			m_SecondaryButton1.PlayInAnims(GUIAnimSystemFREE.eGUIMove.SelfAndChildren);
		}
		else
		{
	...
	void ToggleButton_2()
	{
		...
		if(m_Button2_IsOn==true)
		{
			...
			m_SecondaryButton2.PlayInAnims(GUIAnimSystemFREE.eGUIMove.SelfAndChildren);
		}
		else
		{
	...
	void ToggleButton_3()
	{
		...
		if(m_Button3_IsOn==true)
		{
			...
			m_SecondaryButton3.PlayInAnims(GUIAnimSystemFREE.eGUIMove.SelfAndChildren);
		}
		else
		{
	...
	void ToggleButton_4()
	{
		...
		if(m_Button4_IsOn==true)
		{
			...
			m_SecondaryButton4.PlayInAnims(GUIAnimSystemFREE.eGUIMove.SelfAndChildren);
		}
		else
		{
	...
	void ToggleButton_5()
	{
		...
		if(m_Button5_IsOn==true)
		{
			...
			m_SecondaryButton5.PlayInAnims(GUIAnimSystemFREE.eGUIMove.SelfAndChildren);
		}
		else
		{
